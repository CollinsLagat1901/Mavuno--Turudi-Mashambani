...
export default function ChatBox() {
  ...
  const starterPrompts = [
    "What's the price of avocados in Murang'a?",
    "Find maize sellers in Nakuru County.",
    "Draft an offer for 10 tons of potatoes.",
    "Which county has the cheapest beans today?",
  ];
        ...
        <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-2 overflow-hidden px-1">
                <div className="rounded-xl bg-muted p-4">
                    <p className="text-sm font-medium">Hello! I'm Mavuno, your personal AI sourcing assistant. How can I help you find the best produce today?</p>
                </div>
            </div>
        </div>
