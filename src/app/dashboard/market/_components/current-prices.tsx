...
const priceData = [
  { crop: 'Maize', location: 'Nairobi', price: 65, trend: 5, lastUpdated: 'Today' },
  { crop: 'Beans', location: 'Nakuru', price: 110, trend: -2, lastUpdated: 'Yesterday' },
  { crop: 'Tomatoes', location: 'Kiambu', price: 130, trend: 8, lastUpdated: 'Today' },
  { crop: 'Potatoes', location: 'Eldoret', price: 50, trend: 0, lastUpdated: '3 days ago' },
  { crop: 'Avocado', location: 'Muranga', price: 90, trend: 3, lastUpdated: 'Today' },
];
